...
import "./Nav.css";
import logo from "./images/llll.png";
      ...
      <div class="nav container-fluid ">
        <nav class="navbar navbar-expand-lg">
          <button
            ...
            aria-controls="navbarSupportedContent end"
            aria-expanded="false"
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search">
              <input
                ...
                aria-label="Search"
              />
              <button class="btn btn-outline-success" type="submit" id="btn2">
                Search
              </button>
            </form>
          </div>
